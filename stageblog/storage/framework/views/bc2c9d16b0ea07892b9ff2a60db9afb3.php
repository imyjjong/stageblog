        ...
        <div class="blog__wrapper">
            <article class="blog__info">
                ...
                <span class="blog__info--wrapper">
                    <h3 class="blog__info--wrappper-stage"><?php echo e($post->stage); ?></h3>
                    <h3 class="blog__info--wrapper-published"><?php echo e($post->published); ?></h3>
                </span>
            </article>
                    ...
                    <?php $__currentLoopData = $comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <article class="blog__comment">
                            <span class="blog__comment--wrapper">
                                ...
                                <h3 class="blog__comment-wrapper-date"><?php echo e($comment->created_at->format('d-m-y')); ?></h3>
                            </span>
